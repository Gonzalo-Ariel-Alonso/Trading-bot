from Strategys_and_Backtesting import trading_strategy
from Data_base import DB_targeted,Japanese_Candle
import json
...
def run_strategy(strategy,comentaries = True):
    ...
    while a_row:
        a_candle = Japanese_Candle.m5_Candle(a_row[0],a_row[1],a_row[2],a_row[3],a_row[4],a_row[5],a_row[6],a_row[7],a_row[8],a_row[9])
